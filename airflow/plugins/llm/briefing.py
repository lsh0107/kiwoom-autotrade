...
## 허용 테마 어휘 (theme_scores / weight_adjustments는 이 중에서만 선택)
반도체, 2차전지, 자동차, 바이오, 제약, IT플랫폼, 금융, 게임, 엔터, 조선,
철강, 건설, 지주, 방산, 에너지, 소비재, 유통, 통신, 화학, AI로봇

## 응답 형식 (JSON만 출력)
{{
  "summary": "시장 요약 (한글, 300자 이내)",
  "theme_scores": {{
    "테마명(위 허용 어휘에서만)": 0.0~1.0,
    ...
  }},
  "risk_flags": ["리스크 항목1", "리스크 항목2"],
  "weight_adjustments": {{
    "테마명(위 허용 어휘에서만)": -0.2~0.2,
    ...
  }}
}}
"""
