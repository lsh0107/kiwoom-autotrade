...
> design-001-system-v1.md 전문가 리뷰 + 전략 v2.0 전문가 토론에서 도출.
> **마지막 검토**: 2026-06-11
> **상태**: 3월 항목은 대부분 확정/역사화 (아래 Historical). 현재 pending 은 "2026-06 현재 미결정" 섹션 참조.
...
| # | 항목 | 결정 시점 | 비고 |
|---|---|---|---|
| P-1 | PR 2b/3 착수 (total-equity budget / ownership·sell authority) | 6/15 본 관찰 후 또는 사용자 명시 해제 | 설계 초안 보유 (pr2b 미커밋) |
| P-2 | short_swing 실활성 | PR 2b/3 완료 + 운영 잠금 해제 후 | 코드 완료, 운영 잠금 |
| P-3 | 6/12 mini trigger smoke 실행 | 사용자 "mini trigger smoke go" | observation plan §11.8 |
| P-4 | 본 관찰 종료 후 다음 단계 (N1 연장 / N2 P2 audit / N3 PR E2 / N4 추가 전략) | 회부 시점 (T+16) | plan §6.3 — 사전 확정 금지 |
| P-5 | risk_off 지속 시 6/15 가동 보류/축소 여부 | 6/15 직전 preflight + regime 추이 보고 | 6/11 기준 risk_off 3일 연속 |

---

## (이하 Historical — 2026-03 결정 기록)
...
- **확정일**: 2026-03-04
- **반영**: design-001-system-v1.md 섹션 13 (Docker Compose)
- **근거**: $0 비용, 단일 인프라 관리
