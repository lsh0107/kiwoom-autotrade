...
| 020 | [design-020](docs/design/design-020-extended-validation.md) | 확장 검증 (59종목·3년·27 combo) → 일봉 카테고리 전체 폐기 |

## 운영 체크리스트

**전략 검증 현황 (2026-04-27)**: 누적 폐기 5건. 일봉 Pullback/Range/MR 카테고리 전체 제외 확정 (ADR-020). 후속 방향 미결정. 모의투자 차단 유지.
