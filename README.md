...
**전략 검증 현황 (2026-04-28)**: 누적 폐기 5건. **ADR-021 cross-sectional momentum V2 기준 PASS** (top20pct_novol_notrend, 33%). **ADR-022 어댑터 구현 완료** (21 신규 + 611 회귀 PASS, 커버리지 85.05%). `USE_CROSS_MOMENTUM=true` 설정 후 모의 4주 관찰 시작 가능. 실전 전환은 모의 4주 기준 통과 + 사용자 명시적 승인 필수.
